...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='forward_to_upstream_ca', full_name='istio.mesh.v1alpha1.MeshConfig.forward_to_upstream_ca', index=50,
